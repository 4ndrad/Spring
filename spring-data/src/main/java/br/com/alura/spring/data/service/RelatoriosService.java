...
public class RelatoriosService {
	...
	public void inicial(Scanner scanner) {
		while (system) {
			...
			System.out.println("2 - Buscar funcionario por nome e salario");
			System.out.println("3 - Buscar funcionario por nome, salario e data de Contratação");
			System.out.println("4 - Buscar funcionario por data de Contratação");
